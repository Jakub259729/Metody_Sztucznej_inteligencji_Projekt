...
class Adasyn:
    ...
    def __init__(self, beta, n_neighbors, random_state=None):
        self.beta = beta
...
#Generowanie danych
X, y = make_classification(n_classes=2, class_sep=2, weights=[0.75, 0.25], n_informative=5, n_redundant=0, flip_y=0, n_features=10, n_clusters_per_class=7, n_samples=1000)
...
#Wykonanie ADASYN
adasyn = Adasyn(beta=0.9, n_neighbors=3)
